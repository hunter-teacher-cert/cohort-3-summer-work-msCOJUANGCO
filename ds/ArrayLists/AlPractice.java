...
2)buildRandomList(int size, int maxval)
3) public static int sumOfList(ArrayList<Integer> dataList)

Intermediate level:
-------------------
4) public static void swapElements(ArrayList<Integer> dataList, int indexA,int indexB)
5)public static void removeValue(ArrayList<Integer> dataList, int valueToRemove)
  ...
  */
  public static ArrayList<Integer> buildRandomList(int size, int maxval){
    ...
    for(int i =0; i < size; i++){
      ...
      //al[i] = number;
      al.add(random.nextInt(maxval));
      
    }
    
      return al;//placeholder to compile.
  }
/*
public class Test{
