...
This file contains the following completed method. Use it as a modelto help you with the other methods:
   - buildBoard
...
//     //   for (int j = 0; j < cols; j++) {
//     //     board[i][j]=value;
// //           string[] x = {1, 9, 4} ; // declare and init x
...
public static char[][] copyBoard( char[][] original)
  ...
  /**
     ...
     A location in a 2D array can be though of as having 8 neighbors.  In the below 2D array, the neighbors of the element
